      ...
      <form method='' ref='form' @submit.prevent='sendEmail'>
        <div class="w-full flex flex-wrap sm:flex-nowrap gap-4 mt-4">
          <div class="w-full flex flex-col items-start">
            ...
            <input type='text' placeholder='Jean' class="w-full p-2 rounded-md border-dark-grey border" ref="firstname"
              name="firstname" v-model="formData.firstname" @input="validateForm" />
          </div>
          <div class="w-full flex flex-col items-start">
            <label for='lastname' class="w-full">Nom</label>
            <input type='text' placeholder='Dupont' class="w-full  p-2 rounded-md border-dark-grey border" ref="lastname"
        ...
        <div class="w-full flex flex-wrap sm:flex-nowrap gap-4 mt-4">
          <div class="w-1/2 flex flex-col items-start">
            ...
            <input type='mail' placeholder='jean.dupont@gmail.com' class="w-full p-2 rounded-md border-dark-grey border"
              ref="mail" name="mail" v-model="formData.mail" @input="validateForm" />
          </div>
          <div class="w-1/2 flex flex-col items-start">
            <label for='tel' class="w-full">Téléphone</label>
            <input type='tel' placeholder='0612121212' class="w-full p-2 rounded-md border-dark-grey border" ref="tel"
        ...
        <div class="w-full mt-4 flex flex-col items-start">
          ...
          <textarea placeholder='Je vous contact pour ...' class="w-full p-2 rounded-md border-dark-grey border"
