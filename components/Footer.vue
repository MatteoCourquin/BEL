  ...
  <footer class="bg-black py-16">
    <div class="max-w-default h-fit mx-auto px-x-default">
          ...
          <div class="w-full flex flex-col sm:flex-row items-start space-y-8 sm:space-y-0">
            <div class="flex flex-col space-y-4">
              <p class="text-white flex items-center mr-8">
                Bureau d'Études Legavre :
              </p>
              <p class="text-white flex items-center mr-8">
                7 rue Surcouf – ZA D’Atlantheix <br> 56450 THEIX-NOYALO
              </p>
            </div>
            <div class="flex flex-col space-y-4">
              <p class="text-white flex items-center mr-8">
      ...
      <div class="flex items-center justify-center text-white">
        <p class="text-sm text-white mt-3 md:mt-0">© 1988 - {{ dateYear }} • Zèle Solutions. Tous droits réservés.</p>
      </div>
    </div>
  </footer>
</template>
